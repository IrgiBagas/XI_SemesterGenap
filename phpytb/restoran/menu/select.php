<div class="float-left mt-5">
    <a href="?f=menu&m=insert" class="btn btn-primary" role="button">TAMBAH DATA</a>
</div>
...
<div class="mt-4 mb-4">
    ...
    <form action="" method="post">
        <select name="opsi" id="" onchange="this.form.submit()">
            ...
            <option <?php if($r['idkategori']==$opsi) echo "selected"; ?> value="<?php echo $r['kategori']?>"><?php echo $r['kategori']?></option>
            <?php endforeach ?>
        </select>
    </form>
</div>
